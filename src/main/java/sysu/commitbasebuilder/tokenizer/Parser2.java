package sysu.commitbasebuilder.tokenizer;
...
import sysu.commitbasebuilder.bean.TokenType;
                ...
                unit.accept(new ASTVisitor() {
                    ...
                    public boolean	visit(MethodDeclaration node) {
                        ...
                        for(Object para:node.parameters()){
                        	paras.append(para.toString());
                        }
                        tk.addToken("MethodDeclaration",node.getName().getFullyQualifiedName()+"("+paras.toString()+")",startLine,endLine,TokenType.MethodDeclaration.ordinal());
                        return true;
                    }
